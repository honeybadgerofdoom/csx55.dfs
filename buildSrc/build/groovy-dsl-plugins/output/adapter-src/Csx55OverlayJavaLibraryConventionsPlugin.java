...
/**
 * Precompiled csx55.overlay.java-library-conventions script plugin.
 **/
public class Csx55OverlayJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Csx55OverlayJavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Csx55OverlayJavaLibraryConventions").asSubclass(BasicScript.class);
